...
public class ProcedureEditor extends CustomWidget
{
  ...
  private BMenu getInsertMenu()
  {
    ...
    List<java.lang.Module> plugins = PluginRegistry.getPlugins(java.lang.Module.class);
    if (plugins.size() > 0)
    {
  ...
  {
    OutputModule output[] = proc.getOutputModules();
    java.lang.Module module[] = proc.getModules();
  ...
  private void actionPerformed(CommandEvent e)
  {
    ...
    else
    {
      try
      {
        ...
        java.lang.Module mod = (java.lang.Module) cl.newInstance();
  ...
  private void addModule(java.lang.Module mod)
  {
  ...
  private void startDragLink(IOPort port)
  {
    ...
    if (isInput)
      {
        java.lang.Module module = port.getModule();
  ...
  private static class ClipboardSelection
  {
    ...
    public ClipboardSelection(Procedure proc, boolean selectedModule[], boolean selectedLink[])
    {
      ...
      java.lang.Module allModules[] = proc.getModules();
      ...
      module = new java.lang.Module[mod.size()];
      link = new Link [ln.size()];
      for (int i = 0; i < module.length; i++)
        module[i] = ((java.lang.Module) mod.elementAt(i)).duplicate();
      for (int i = 0; i < link.length; i++)
        {
    ...
    public void paste(ProcedureEditor editor)
    {
      ...
      java.lang.Module realMod[] = new java.lang.Module[module.length];
