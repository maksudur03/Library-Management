...
public class Procedure
{
  ...
  public java.lang.Module[] getModules()
  {
    return module;
  }
  ...
  public int getModuleIndex(java.lang.Module mod)
  {
  ...
  public int getOutputIndex(java.lang.Module mod)
  {
  ...
  public void addModule(java.lang.Module mod)
  {
    java.lang.Module newmod[] = new java.lang.Module[module.length+1];
    for (int i = 0; i < module.length; i++)
      newmod[i] = module[i];
  ...
  {
    module = new java.lang.Module[proc.module.length];
    for (int i = 0; i < module.length; i++)
      module[i] = proc.module[i].duplicate();
    link = new Link [proc.link.length];
    for (int i = 0; i < link.length; i++)
      {
        java.lang.Module fromModule = proc.link[i].from.getModule();
        java.lang.Module toModule = proc.link[i].to.getModule();
  ...
  public void readFromStream(DataInputStream in, Scene theScene) throws IOException, InvalidObjectException
  {
    ...
    module = new java.lang.Module[in.readInt()];
    try
      {
        for (int i = 0; i < module.length; i++)
          {
            ...
            module[i] = (java.lang.Module) con.newInstance(new Object [] {p});
