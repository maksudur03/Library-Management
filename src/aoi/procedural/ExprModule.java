...
class OPort { 
    ...
    OPort (java.lang.Module m, int p, Arg [] i) {
        module = m; 
        oport = p; 
        args = i; 
    } 
 
    OPort (java.lang.Module m, int p) {
        module = m; 
        oport = p; 
    } 
 
    OPort (java.lang.Module m) {
        module = m; 
        oport = 0; 
    } 
    IOPort getOPort () { 
...
class ModuleLoader { 
   public static java.lang.Module createModule (String name) {
        Class moduleClass; 
    ...
    public static java.lang.Module dummy () {
        return new NumberModule (new Point (), 0.1234567); 
    } 
 
    public static java.lang.Module createModule (Class moduleClass) {
        ...
        try { 
            ...
            mod = (java.lang.Module) cons.newInstance (wrappedPoint);
...
public class ExprModule extends java.lang.Module
{ 
 
    Hashtable varTable; 
    java.lang.Module[] inputs;
    java.lang.Module[] myModules;
    Vector moduleVec;
    OPort compiled; 
    Token [] tokens; 
    Token currTok; 
    ...
    public java.lang.Module duplicate()
    { 
    ...
    void compile () { 
        ...
        getToken (); 
        compiled = expr (false); 
        myModules = new java.lang.Module[moduleVec.size()];
    ...
    void addModule (java.lang.Module m) {
        if (m == null) { 
    ...
    void clearModules () { 
        myModules = new java.lang.Module[0];
    } 
...
/*            for (int i = 0; i < func.args.length; i ++) { 
    ...
    OPort createNumberPort (double v) { 
        java.lang.Module m = new NumberModule (zero, v);
        return new OPort (m); 
    } 
